...
test('notatka leada: dane, wynik, znacznik zgody, UTM (zgoda bez pelnych tekstow)', () => {
  ...
  assert.ok(n.startsWith('[Zgoda-kalkulator] kanał=telefon-wycena; czas=2026-09-25T10:00:00.000Z; wersja=wycena-2026-09-25-v9'))
  ...
  assert.ok(CONSENT_VERSION.endsWith('-v9') && !CONSENT_VERSION.includes('DO-PRAWNIKA'))
})
test('notatka leada: z zgoda marketingowa i dlugim UTM miesci sie w limicie 500 znakow backendu, znacznik zgody nieuciety', () => {
  ...
  assert.ok(n.startsWith('[Zgoda-kalkulator] kanał=telefon-wycena,marketing-telefon; czas=2026-09-25T10:00:00.000Z; wersja=wycena-2026-09-25-v9'))
...
test('teksty v9: okres marketingu wg wariantu A, kopia dokumentu z zabezpieczeniami, IP okolo doby, Z3 w "Jak liczymy"', async () => {
  ...
  assert.ok(T.how.body[T.how.body.length - 1].includes('Zgoda marketingowa (telefon) wygasa do 12'))
})
