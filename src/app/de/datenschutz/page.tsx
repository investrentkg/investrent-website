...
export default function DatenschutzPage() {
  return (
    <LegalShell title="Datenschutzerklärung">
      ...
      <P>
        Unser Bewertungsrechner (KI-gestützte, unverbindliche Wertspanne für Immobilien in Kołobrzeg und Umgebung) steht derzeit nur in polnischer Sprache zur Verfügung und richtet sich nicht an Nutzer dieser deutschen Fassung. Alle Informationen zur Datenverarbeitung im Rechner (Eingaben zur Immobilie, eingesetzte KI-Dienstleister, Rückrufwunsch mit zwei getrennten Kontrollkästchen, Schutz vor Missbrauch) finden Sie in der polnischen Datenschutzerklärung unter <a href="/rodo" style={link}>/rodo</a>. Sollte der Rechner künftig auf Deutsch angeboten werden, ergänzen wir diese Erklärung vor dem Start.
      ...
      <P>
        Auf den deutschsprachigen Seiten dieser Website setzen wir Cloudflare Turnstile nicht ein. Der Dienst (Cloudflare, Inc., USA) wird ausschließlich auf der polnischsprachigen Seite des Bewertungsrechners geladen; Einzelheiten stehen in der polnischen Fassung unter <a href="/rodo" style={link}>/rodo</a>.
      ...
      <P>
        Zu Werbezwecken kontaktieren wir Sie nur dann, wenn Sie in den jeweiligen Kommunikationskanal zuvor ausdrücklich eingewilligt haben: per E-Mail auf Grundlage des optionalen Kontrollkästchens im Formular (siehe Abschnitt 7) und per Telefon/SMS ausschließlich, wenn Sie im (polnischsprachigen) Bewertungsrechner das optionale Kontrollkästchen für Werbung per Telefon und SMS aktiv auswählen (siehe polnische Fassung unter /rodo). Werbung per Messenger (z. B. WhatsApp) führen wir nicht durch; schreiben Sie uns von sich aus über WhatsApp, antworten wir auf Ihre konkrete Anfrage (Art. 6 Abs. 1 lit. b DSGVO). Ein von Ihnen ausdrücklich erbetener Rückruf oder eine Antwort auf Ihre konkrete Anfrage erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO. Sie können Ihre Einwilligung jederzeit widerrufen (siehe Abschnitt 15); nach dem Widerruf erhalten Sie keine Werbung mehr über den betroffenen Kanal.
      ...
      <UL>
        ...
        <LI>Google (Gemini API, Google Ireland Limited bzw. Google LLC) – Erstellung von Objektplakaten;</LI>
