            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 12 }}>
              {[
                ...
                <div key={i} style={{ textAlign: 'center', padding: '20px', minWidth: 0 }}>
                  <div style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 900, fontSize: 'clamp(20px, 6vw, 36px)', color: '#0d2a5c', marginBottom: 4, wordBreak: 'break-word' as const }}>{st.val}</div>
