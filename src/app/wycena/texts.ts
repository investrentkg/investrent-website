  ...
  lead: {
    ...
    consentInfo: [
      ...
      { h: 'Jak długo.', t: 'Okresy przechowywania:', items: [
        ...
        'zapytanie z numerem telefonu: do 12\u00A0miesięcy od ostatniego kontaktu z Tobą w sprawie wyceny (rozmowa lub wiadomość), a jeśli do kontaktu nie doszło, od dnia zapytania. Jeśli rozmowy doprowadzą do umowy, dane z tych rozmów przechowujemy tak długo, jak wymagają tego przepisy. Razem ze zgłoszeniem wygasa dowód zgody na telefon w sprawie wyceny (wersja zgody, kanał, czas).',
      ] },
