...
export const T = {
  ...
  lead: {
    ...
    consentInfo: [
      ...
      { h: 'Jak długo.', t: 'Okresy przechowywania:', items: [
        ...
        'kontakt marketingowy (telefon): możliwy tylko do 12\u00A0miesięcy od ostatniego kontaktu z Tobą w sprawie wyceny (rozmowy lub wiadomości; rozmowa marketingowa tego okresu nie wydłuża), a jeśli do kontaktu nie doszło, od dnia zapytania. Po tym czasie nie będziemy już do Ciebie dzwonić w celach marketingowych na podstawie tej zgody, także jeśli nadal przechowujemy Twój numer z innego powodu (np. w związku z umową); zgodę możesz cofnąć wcześniej;',
  ...
  how: {
    ...
    body: [
      ...
      'Jak długo: zapytanie bez numeru telefonu 12\u00A0miesięcy od dnia zapytania (potem zostaje sama statystyka); zapytanie z numerem do 12\u00A0miesięcy od ostatniego kontaktu z Tobą (rozmowy lub wiadomości w sprawie wyceny), a jeśli do kontaktu nie doszło, od dnia zapytania. Dowód zgód przechowujemy 3\u00A0lata od końca roku, w którym zgodę cofnięto lub zakończono przetwarzanie. Po usunięciu danych zgłoszenia zostaje z niego wersja zgody, kanał, czas i skrót numeru telefonu. Zgoda marketingowa (telefon) wygasa do 12\u00A0miesięcy od ostatniego kontaktu z Tobą w sprawie wyceny, także jeśli nadal przechowujemy Twój numer z innego powodu (np. w związku z umową). Zgodę możesz cofnąć w każdej chwili, pisząc na biuro@investrent.com.pl lub mówiąc o tym podczas rozmowy. Szczegóły: polityka prywatności (RODO).',
    ],
