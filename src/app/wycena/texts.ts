...
export const T = {
  ...
  fields: {
    ...
    district_hint: 'Bez dzielnicy nie policzymy widełek dla mieszkania w Kołobrzegu. Na przykład: Podczele, Radzikowo. Dla Śródmieścia widełek nie podajemy — wycenę przygotuje agent. Wpisz tylko nazwę dzielnicy lub osiedla; nie wpisuj imion, adresu ani numeru telefonu.',
  ...
  lead: {
    ...
    consentInfo: [
      ...
      { h: 'Jak długo.', t: 'Okresy przechowywania:', items: [
        ...
        'zapytanie bez numeru telefonu: dane nieruchomości i wynik zapisujemy bez danych kontaktowych i adresu IP; po 12\u00A0miesiącach od dnia zapytania usuwamy szczegółowy opis wyceny, a zostaje statystyka (typ, przedział powierzchni co 10\u00A0m², miejscowość, dzielnica, stan, widełki ceny, data), która nie pozwala nam Cię zidentyfikować;',
        'zapytanie z numerem telefonu: nie dłużej niż 12\u00A0miesięcy od ostatniego kontaktu z Tobą w sprawie wyceny (rozmowa lub wiadomość), a najdalej 24\u00A0miesiące od pierwszego zgłoszenia; jeśli do kontaktu nie doszło, 12\u00A0miesięcy od zgłoszenia. Jeśli rozmowy doprowadzą do umowy, dane z tych rozmów przechowujemy tak długo, jak wymagają tego przepisy. Razem ze zgłoszeniem wygasa dowód zgody na telefon w sprawie wyceny (wersja zgody, kanał, czas).',
      ] },
  ...
  how: {
    ...
    body: [
      ...
      'Jak długo: zapytanie bez numeru telefonu 12\u00A0miesięcy od dnia zapytania (potem zostaje sama statystyka); zapytanie z numerem nie dłużej niż 12\u00A0miesięcy od ostatniego kontaktu z Tobą w sprawie wyceny (rozmowy lub wiadomości), a najdalej 24\u00A0miesiące od pierwszego zgłoszenia; jeśli do kontaktu nie doszło, 12\u00A0miesięcy od zgłoszenia; razem z nim wygasa dowód zgody na telefon w sprawie wyceny. Zgodę na telefon w sprawie wyceny możesz cofnąć w każdej chwili, pisząc na biuro@investrent.com.pl lub mówiąc o tym podczas rozmowy. Szczegóły: polityka prywatności (RODO).',
    ],
