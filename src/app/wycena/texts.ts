...
export const T = {
  ...
  lead: {
    ...
    consentInfo: [
      ...
      { h: 'Jak długo.', t: 'Okresy przechowywania:', items: [
        ...
        'zapytanie z numerem telefonu: jeśli dojdzie do umowy, dane związane z umową przechowujemy tak długo, jak wymagają tego przepisy. Poza tym zapytanie usuwamy nie później niż 12\u00A0miesięcy po ostatniej rozmowie z Tobą lub Twojej wiadomości w sprawie wyceny, a najpóźniej 24\u00A0miesiące po pierwszym zgłoszeniu z tego numeru (ponowne zgłoszenie tego terminu nie odnawia). Jeśli do rozmowy lub wiadomości nie doszło, usuwamy je po 12\u00A0miesiącach od zgłoszenia. Nieodebrane próby kontaktu z naszej strony tych okresów nie wydłużają;',
  ...
  how: {
    ...
    body: [
      ...
      'Jak długo: zapytanie bez numeru telefonu 12\u00A0miesięcy od dnia zapytania (potem zostaje sama statystyka). Zapytanie z numerem: jeśli dojdzie do umowy, dane związane z umową przechowujemy tak długo, jak wymagają tego przepisy; poza tym usuwamy je nie później niż 12\u00A0miesięcy po ostatniej rozmowie z Tobą lub Twojej wiadomości w sprawie wyceny, a najpóźniej 24\u00A0miesiące po pierwszym zgłoszeniu z tego numeru (ponowne zgłoszenie tego terminu nie odnawia), a bez rozmowy lub wiadomości 12\u00A0miesięcy od zgłoszenia; nieodebrane próby kontaktu z naszej strony okresów nie wydłużają. Razem ze zgłoszeniem wygasa dowód zgody na telefon w sprawie wyceny. Zgodę na telefon w sprawie wyceny możesz cofnąć w każdej chwili, pisząc na biuro@investrent.com.pl lub mówiąc o tym podczas rozmowy. Szczegóły: polityka prywatności (RODO).',
    ],
