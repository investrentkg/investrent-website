  ...
  lead: {
    ...
    consentInfo: [
      ...
      { h: 'Po co i na jakiej podstawie.', t: 'Wykorzystujemy Twoje dane w tych celach:', items: [
        ...
        'rozmowy o współpracy, o które sam(a) poprosisz, oraz umowa — działania na Twoje żądanie przed zawarciem umowy i wykonanie umowy (art.\u00A06 ust.\u00A01 lit.\u00A0b RODO);',
      ...
      { h: 'Komu przekazujemy dane.', t: 'Dostawcom usług IT: hostingu strony (Vercel), hostingu serwera (Railway), bazy danych (Supabase), usługi AI (Anthropic) i danych rynkowych (Cenogram), którym przekazujemy wyłącznie dane nieruchomości, ochrony formularza (Cloudflare Turnstile, adres IP i informacje o przeglądarce), poczty e-mail, którą powiadamiamy pracowników biura o zgłoszeniu (Brevo, czyli Sendinblue SAS z siedzibą we Francji, na podstawie umowy powierzenia będącej częścią regulaminu usługi; imię, numer telefonu i treść zgłoszenia), oraz kalendarza Google pracowników biura, jeśli mają go połączonego z naszym systemem (zadanie oddzwonienia z imieniem, bez numeru telefonu, z odnośnikiem do karty w naszym systemie). Część dostawców ma siedzibę w USA lub może przetwarzać dane poza Europejskim Obszarem Gospodarczym. Na Twój wniosek (biuro@investrent.com.pl) wskażemy zabezpieczenie zastosowane wobec danego dostawcy oraz, jeśli to standardowe klauzule umowne, prześlemy ich kopię. Zabezpieczenia przekazań poza EOG:', items: [
        ...
        'Vercel (hosting strony): Data Privacy Framework;',
      ...
      { h: 'Jak długo.', t: 'Okresy przechowywania:', items: [
        ...
        'zapytanie z numerem telefonu, zwykle: usuwamy je 12\u00A0miesięcy po ostatniej rozmowie z Tobą lub Twojej wiadomości w sprawie wyceny;',
        ...
        'zapytanie z numerem telefonu, wyjątki: jeśli dojdzie do umowy, dane związane z umową przechowujemy tak długo, jak wymagają tego przepisy; jeśli sam(a) poprosisz o rozmowy o współpracy, dane związane z tymi rozmowami przechowujemy najdłużej 12\u00A0miesięcy od ostatniej takiej rozmowy;',
