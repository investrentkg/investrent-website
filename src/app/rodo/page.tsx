        ...
        <div style={{ background: 'white', padding: '48px 0 64px' }}>
          <div className="container" style={{ maxWidth: 780 }}>
            <div style={{ fontSize: 14.5, color: '#374151', lineHeight: 1.85 }}>
              ...
              {/* Potwierdzic DevTools w dniu wdrozenia: brak polaczen do google/youtube/vimeo przed kliknieciem, brak cookies od nas; sessionStorage tylko ir_launcher_hints (ChatWidget). */}
              ...
              <P>
                Zdjęcia ofert i pracowników oraz obrazy w wpisach blogowych są ładowane z magazynu naszego dostawcy bazy danych (Supabase Storage; art. 6 ust. 1 lit. f RODO); pojedyncze zdjęcia stockowe z Unsplash są dostarczane przez naszego dostawcę hostingu Vercel, więc Państwa przeglądarka nie łączy się w tym celu z Unsplash. Opinie Google pokazujemy bez zdjęć profilowych. Używane przez nas czcionki są serwowane z naszego własnego serwera. My sami nie stosujemy na stronie plików cookies ani trwałej pamięci lokalnej przeglądarki; okno czatu zapamiętuje jedynie w pamięci sesji przeglądarki (do zamknięcia karty), czy wyświetliliśmy już podpowiedź, bez danych osobowych.
              </P>
