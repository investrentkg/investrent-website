        ...
        <div style={{ background: 'white', padding: '48px 0 64px' }}>
          <div className="container" style={{ maxWidth: 780 }}>
            <div style={{ fontSize: 14.5, color: '#374151', lineHeight: 1.85 }}>
              ...
              <P>
                Zdjęcia ofert i pracowników oraz obrazy w wpisach blogowych są ładowane z magazynu naszego dostawcy bazy danych (Supabase Storage), pojedyncze zdjęcia stockowe z Unsplash (images.unsplash.com); przy tych pobraniach Państwa adres IP trafia do danego serwera (art. 6 ust. 1 lit. f RODO). Zdjęcia profilowe przy opiniach Google pochodzą z serwerów wskazanych w danych opinii <Ph>[DO POTWIERDZENIA: host awatarów w /api/public/google-reviews]</Ph>. Używane przez nas czcionki są serwowane z naszego własnego serwera. My sami nie stosujemy na stronie plików cookies ani nie zapisujemy danych w pamięci lokalnej przeglądarki.
              </P>
              ...
              <P>
                ...
                Przy prośbie o oddzwonienie w kalkulatorze (po wdrożeniu nowej strony kalkulatora) dostępne są dwa oddzielne pola wyboru, które zaznaczają Państwo samodzielnie: (1) zgoda na telefon w sprawie wyceny nieruchomości – wymagana, abyśmy mogli zadzwonić pod podany numer; (2) zgoda na marketing bezpośredni przez telefon i SMS – oferty pośrednictwa i inne oferty Investrent sp. z o.o. – dobrowolna, niezaznaczona domyślnie i niewymagana do skorzystania z kalkulatora ani do oddzwonienia w sprawie wyceny (art. 6 ust. 1 lit. a RODO; art. 398 Prawa komunikacji elektronicznej). Obie zgody mogą Państwo w każdej chwili cofnąć (patrz „Prawa osób, których dane dotyczą”). Datę, treść i źródło zgód zapisujemy w celu wykazania ich udzielenia (art. 7 ust. 1 RODO).
              </P>
              <P>
